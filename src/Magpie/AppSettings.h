...
struct _AppSettingsData {
	...
	// UI mode: true = simple mode, false = advanced mode
...
public:
	...
	// Simple mode accessor
	bool IsSimpleMode() const noexcept { return _isSimpleMode; }

	void IsSimpleMode(bool value) noexcept;
