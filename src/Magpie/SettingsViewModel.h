...
struct SettingsViewModel : SettingsViewModelT<SettingsViewModel>,
	...
	bool IsSimpleMode() const noexcept;
	void IsSimpleMode(bool value);

	Windows::UI::Xaml::Visibility SimpleModeVisibility() const noexcept;
	Windows::UI::Xaml::Visibility AdvancedModeVisibility() const noexcept;
};
